...
"[project]/.next-internal/server/app/api/weather/current/coordinates/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/weather/current/coordinates/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (redirect && data && data.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/weather/${data.id}`, request.nextUrl.origin));
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c426d032._.js.map