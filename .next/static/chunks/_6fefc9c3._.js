...
"[project]/src/components/weather-map.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function WeatherMap({ layer = "temp_new", width = "100%", height = "70vh", zoom = 4, lat = 55.7558, lon = 37.6173 }) {
    _s();
    ...
    const [currentZoom, setCurrentZoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(zoom);
    ...
    const [hoveredLocation, setHoveredLocation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [locationWeather, setLocationWeather] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WeatherMap.useEffect": ()=>{
            ...
            const loadMap = {
                "WeatherMap.useEffect.loadMap": async ()=>{
                    try {
                        // Проверяем, загружена ли библиотека
                        if ("object" !== 'undefined' && !window.ol) {
                            ...
                            await new Promise({
                                "WeatherMap.useEffect.loadMap": (resolve)=>{
                                    script.onload = resolve;
                                    document.head.appendChild(script);
                                }
                            }["WeatherMap.useEffect.loadMap"]);
                        }
                        ...
                        if (window.ol && mapRef.current) {
                            ...
                            map.on('click', {
                                "WeatherMap.useEffect.loadMap": async (evt)=>{
    ...
    const handleLocate = ()=>{
        if (mapInstance && 'geolocation' in navigator) {
            navigator.geolocation.getCurrentPosition((position)=>{
                ...
                fetch(`/api/weather/current/coordinates?lat=${latitude.toFixed(4)}&lon=${longitude.toFixed(4)}`).then((response)=>response.json()).then((data)=>{
                    setHoveredLocation({
                        lat: latitude,
                        lon: longitude,
    ...
    const getLayerDescription = (layerId)=>{
        switch(layerId){
            case 'temp_new':
                return 'Температура воздуха на карте представлена с помощью цветовой шкалы от синего (холодно) до красного (жарко).';
            case 'precipitation_new':
                return 'Интенсивность осадков с цветовой шкалой от светло-голубого (слабый дождь/снег) до фиолетового (сильные осадки).';
            case 'clouds_new':
                return 'Процент облачности отображается от белого (чистое небо) до темно-серого (полностью облачно).';
            case 'wind_new':
                return 'Скорость ветра показана от светло-зеленого (легкий ветерок) до темно-оранжевого (сильный ветер).';
            case 'pressure_new':
                return 'Атмосферное давление представлено от фиолетового (низкое) до желтого (высокое).';
            default:
                return 'Информация о данном слое отсутствует.';
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/components/weather-map.tsx",
                lineNumber: 251,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute bottom-4 left-4 bg-background/70 backdrop-blur-sm px-3 py-1 rounded-md text-sm font-medium",
                children: [
                    "Масштаб: ",
                    currentZoom
                ]
            ...
            layersOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute top-4 left-4 bg-background/95 backdrop-blur-sm p-4 rounded-md shadow-lg max-w-sm border animate-in fade-in duration-200",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: layer === 'temp_new' ? 'Температура' : layer === 'precipitation_new' ? 'Осадки' : layer === 'clouds_new' ? 'Облачность' : layer === 'wind_new' ? 'Ветер' : layer === 'pressure_new' ? 'Давление' : layer
                            }, void 0, false, {
                                fileName: "[project]/src/components/weather-map.tsx",
                                lineNumber: 319,
                                columnNumber: 27
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                children: getLayerDescription(layer)
                            }, void 0, false, {
                                fileName: "[project]/src/components/weather-map.tsx",
                                lineNumber: 328,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Клик по карте покажет подробную информацию о погоде в выбранной точке."
                            }, void 0, false, {
                                fileName: "[project]/src/components/weather-map.tsx",
                                lineNumber: 329,
                                columnNumber: 13
            ...
            infoOpen && locationWeather && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute bottom-14 right-4 bg-background/95 backdrop-blur-sm p-4 rounded-md shadow-lg max-w-sm border animate-in fade-in slide-in-from-right duration-200",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                ...
                                children: [
                                    ...
                                    " ",
                                    hoveredLocation?.name || "Информация о погоде"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/src/components/weather-map.tsx",
                                lineNumber: 338,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-medium",
                                        children: [
                                            locationWeather.temperature?.air?.C,
                                            "°C"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/weather-map.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-medium",
                                        children: [
                                            locationWeather.temperature?.comfort?.C,
                                            "°C"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/weather-map.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-medium",
                                        children: [
                                            locationWeather.wind?.speed,
                                            " м/с, ",
                                            locationWeather.wind?.direction
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/weather-map.tsx",
                                        lineNumber: 362,
                                    ...
                                    locationWeather.precipitation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "flex items-center gap-1 text-muted-foreground",
                                                children: "Осадки:"
                                    ...
                                    locationWeather.pressure && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "flex items-center gap-1 text-muted-foreground",
                                                children: "Давление:"
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        children: [
                                            "Координаты: ",
                                            hoveredLocation?.lat.toFixed(4),
                                            ", ",
                                            hoveredLocation?.lon.toFixed(4)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/weather-map.tsx",
                                        lineNumber: 385,
                                    ...
                                    locationWeather.description && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-medium mt-1",
                                        children: locationWeather.description
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/weather-map.tsx",
                                        lineNumber: 387,
                                        columnNumber: 17
...
_s(WeatherMap, "NZj48XU8JFoDx5GXF3z+p2yBqS8=");
_c = WeatherMap;
var _c;
...
"[project]/src/components/weather-map.tsx [app-client] (ecmascript, next/dynamic entry)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/src/components/weather-map.tsx [app-client] (ecmascript)"));
}}),
...
//# sourceMappingURL=_6fefc9c3._.js.map